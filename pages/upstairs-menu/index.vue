  ...
  head: {
    ...
    meta: [
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      {
        ...
        name: 'description',
        content:
          'Upstairs menus - Main meals, fish, grills, entrees, salads, desserts & ice cream, hot drinks, beers',
      },
    ],
  },
  data() {
  ...
  asyncData(context) {
    ...
    return context.$axios
      ...
      .then(res => {
        ...
        // TABLE : menus_upstairs_2020_no_header
      })
      .catch(error => {
        context.error({
